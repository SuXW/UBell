...
public class VideoView extends SurfaceView implements MediaPlayerControl
{
	...
	RelativeLayout control_bottom2;
...
//	@Override
	...
	public void changeControl(){
		if(isControlShow){
			...
			control_bottom2.setVisibility(RelativeLayout.GONE);
			LayoutParams laParams = (LayoutParams) this.getLayoutParams();
			...
			this.setLayoutParams(laParams);

		}else{
			isControlShow = true;
			control_bottom.setVisibility(RelativeLayout.VISIBLE);
			control_bottom2.setVisibility(RelativeLayout.VISIBLE);
			
		}
	}

	public RelativeLayout getControl_bottom() {
		return control_bottom;
	}

	public void setControl_bottom(RelativeLayout control_bottom,RelativeLayout control_bottom2) {
		this.control_bottom = control_bottom;
		this.control_bottom2 = control_bottom2;
	}
